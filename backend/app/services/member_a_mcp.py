...
from app.tools.member_a_tools import dispatch_local_tool, member_a_tool_names
...
class MemberAMCPClient:
    ...
    def call_tool(self, name: str, arguments: dict[str, Any]) -> MCPToolResult:
        if name not in member_a_tool_names():
    ...
    def _call_remote(self, name: str, arguments: dict[str, Any]) -> dict[str, Any]:
        ...
        raise RuntimeError("MemberAMCPClient.call_tool must run outside an active event loop")
